...
<input type="submit" name="login" value="login"style="margin-left:75px;margin-top:30px;width:50px;"> <input type="submit" name="cancel" value="cancel"> <input type="submit" name="register" value="Register">
</form>
</div>
